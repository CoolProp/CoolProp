...
def test_phase_envelope_R410A():
    print("Testing mass quality calculations with R410A.MIX at 278.15 K and 0.5 quality")
    print("=" * 49)
    ...
    try:
        ...
        AS.update(CP.QmassT_INPUTS, 0.5, 278.15)  # Saturated vapor (q=0.5 in mass basis)
