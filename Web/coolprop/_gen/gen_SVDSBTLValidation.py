...
nb.cells = [
    _md(
        ...
        "**HEOS** Helmholtz-energy reference across three input pairs. For "
        "`(P, T)` and `(H, P)` each panel shows the **density** error "
        ...
        "**Inputs:** `PT_INPUTS`, `HmassP_INPUTS` (validate `rhomass()`) and `DmassT_INPUTS` (validates `p()`).  \n"
    ...
    _code(
        ...
        "from CoolProp.CoolProp import PT_INPUTS, HmassP_INPUTS, QT_INPUTS, DmassT_INPUTS\n"
        "\n"
