...
From all languages, the configuration state can be obtained by retrieving the configuration state in the form of a `JSON <https://json.org/>`_ formatted string.  For instance, in python, you can get the default configuration state from 
