def collect(tmp):
    ...
    shutil.copytree(
        os.path.join("..", "..", "..", "include"), os.path.join(tmp, "include")
    )
    print("copying externals")
    shutil.copytree(
        os.path.join("..", "..", "..", "externals"), os.path.join(tmp, "externals")
    )
    ...
    shutil.copy2(
        os.path.join("..", "..", "..", ".version"), os.path.join(tmp, ".version")
    )
...
if __name__ == "__main__":
    ...
    try:
        ...
        subprocess.check_call(
            " ".join(["python", "setup.py", "sdist"] + sys.argv[1::]),
            shell=True,
            cwd=tmp,
            stdout=sys.stdout,
            stderr=sys.stderr,
