...
class configuration_keys(enum.IntEnum):
    ...
    MAXIMUM_TABLE_DIRECTORY_SIZE_IN_GB = 14

    DONT_CHECK_PROPERTY_LIMITS = 15

    HENRYS_LAW_TO_GENERATE_VLE_GUESSES = 16

    PHASE_ENVELOPE_STARTING_PRESSURE_PA = 17

    R_U_CODATA = 18

    VTPR_UNIFAC_PATH = 19

    SPINODAL_MINIMUM_DELTA = 20

    OVERWRITE_FLUIDS = 21

    OVERWRITE_DEPARTURE_FUNCTION = 22

    OVERWRITE_BINARY_INTERACTION = 23

    USE_GUESSES_IN_PROPSSI = 24

    ASSUME_CRITICAL_POINT_STABLE = 25

    VTPR_ALWAYS_RELOAD_LIBRARY = 26

    FLOAT_PUNCTUATION = 27

    ENABLE_SUPERANCILLARIES = 28

    ENABLE_MELTING_CALORIC_HS = 29

    HSU_D_TWOPHASE_EOS_POLISH = 30

    LIST_STRING_DELIMITER = 31

    ALLOW_SVDSBTL_IN_PROPSSI = 32

    SVDSBTL_SAMPLING_THREADS = 33

    TABULAR_NX = 34

    MIXTURE_STABILITY_ALGORITHM = 35
...
@overload
def PropsSI(Output: Sequence[str] | NDArray[numpy.str_], Name1: str, Prop1: _Num, Name2: str, Prop2: _Num, FluidName: str, /) -> NDArray[numpy.float64]: ...
