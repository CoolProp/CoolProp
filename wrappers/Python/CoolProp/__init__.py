...
if constants.__file__.rsplit(".", 1)[1] not in ["pyc", "pyo", "py"]:
    ...
    try:
        ...
        print(
            "constants shared library has been removed.  Please restart your python code"
        )
    except:
...
__incompressibles_pure__ = CoolProp.get_global_param_string(
    "incompressible_list_pure"
).split(",")
__incompressibles_solution__ = CoolProp.get_global_param_string(
