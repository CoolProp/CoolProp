...
class PsychOptions(wx.Dialog):
    ...
    def build_contents(self):
        ...
        self.Tmin_label = wx.StaticText(
            self, label="Minimum dry bulb temperature [\xb0 C]"
        )
        self.Tmin = wx.TextCtrl(self, value="-10")
        self.Tmax_label = wx.StaticText(
            self, label="Maximum dry bulb temperature [\xb0 C]"
        )
...
class SaturationTable(wx.Frame):
    ...
    def add_menu(self):
        ...
        mnuItem1 = wx.MenuItem(
            self.File, -1, "Copy selected data \tCtrl+C", "", wx.ITEM_NORMAL
        )
        mnuItem2 = wx.MenuItem(
            self.File, -1, "Copy table w/ headers \tCtrl+H", "", wx.ITEM_NORMAL
        )
    ...
    def OnCopy(self, event=None):
        ...
        rows = (
            self.tbl.GetSelectionBlockBottomRight()[0][0]
            - self.tbl.GetSelectionBlockTopLeft()[0][0]
            + 1
        )
        cols = (
            self.tbl.GetSelectionBlockBottomRight()[0][1]
            - self.tbl.GetSelectionBlockTopLeft()[0][1]
            + 1
        )
...
class MainFrame(wx.Frame):
    ...
    def build(self):
        ...
        self.SatTable = wx.MenuItem(
            self.tables, -1, " Saturation Table", "", wx.ITEM_NORMAL
        )
