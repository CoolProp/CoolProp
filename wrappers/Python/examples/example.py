...
print(
    ...
    CP.Props("D", "P", 101.325, "Q", 0, "Propane"),
    "kg/m^3",
)
print(
    "Density of saturated vapor R290 at 101.325 kPa:",
    CP.Props("D", "P", 101.325, "Q", 1, "R290"),
    "kg/m^3",
)
print("TWO PHASE INPUTS (Temperature)")
print(
    "Density of saturated liquid Propane at 300 K:",
    CP.Props("D", "T", 300, "Q", 0, "Propane"),
    "kg/m^3",
)
print(
    "Density of saturated vapor R290 at 300 K:",
    CP.Props("D", "T", 300, "Q", 1, "R290"),
    "kg/m^3",
)
...
try:
    ...
    print(
        "Density of saturated liquid Propane at 300 K:",
        CP.Props("D", "T", 300, "Q", 0, "REFPROP-propane"),
        "kg/m^3",
    )
    print(
        "Density of saturated vapor Propane at 300 K:",
        CP.Props("D", "T", 300, "Q", 1, "REFPROP-propane"),
        "kg/m^3",
    )
...
print(
    "Vapor pressure of water at 373.15 K in SI units (Pa):",
    CP.Props("P", "T", 373.15, "Q", 0, "Water"),
)
CP.set_standard_unit_system(CoolProp.UNIT_SYSTEM_KSI)
print(
    "Vapor pressure of water at 373.15 K in kSI units (kPa):",
    CP.Props("P", "T", 373.15, "Q", 0, "Water"),
)
...
print(" ")
print(
    "Density of 50% (mass) ethylene glycol/water at 300 K, 101.325 kPa:",
    CP.Props("D", "T", 300, "P", 101.325, "EG-50%"),
    "kg/m^3",
)
print(
    "Viscosity of Therminol D12 at 350 K, 101.325 kPa:",
    CP.Props("V", "T", 350, "P", 101.325, "TD12"),
    "Pa-s",
)
...
print(" ")
print(
    "Humidity ratio of 50% rel. hum. air at 300 K, 101.325 kPa:",
