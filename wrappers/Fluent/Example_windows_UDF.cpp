...
DEFINE_PROPERTY(rho_coolprop, cell, thread) {
    ...
    double rho = PropsSI("VISCOSITY", "P", static_cast<double>(P), "Hmass", static_cast<double>(H), FLUID_NAME.c_str());
...
DEFINE_PROPERTY(mu_coolprop, cell, thread) {
    real P = C_P(cell, thread);
    real H = C_H(cell, thread);
    double mu = PropsSI("VISCOSITY", "P", static_cast<double>(P), "Hmass", static_cast<double>(H), FLUID_NAME.c_str());
...
DEFINE_PROPERTY(k_coolprop, cell, thread) {
    real P = C_P(cell, thread);
    real H = C_H(cell, thread);
    double k = PropsSI("CONDUCTIVITY", "P", static_cast<double>(P), "Hmass", static_cast<double>(H), FLUID_NAME.c_str());
