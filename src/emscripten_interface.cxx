...
EMSCRIPTEN_BINDINGS(abstract_state_bindings) {
    ...
    class_<CoolProp::AbstractState>("AbstractState")
      ...
      .function(
        "set_mass_fractions", +[](CoolProp::AbstractState& self, val arr) { self.set_mass_fractions(js_array_to_vec(arr)); })
      .function(
        "set_volu_fractions", +[](CoolProp::AbstractState& self, val arr) { self.set_volu_fractions(js_array_to_vec(arr)); })
      .function(
        "set_mole_fractions", +[](CoolProp::AbstractState& self, val arr) { self.set_mole_fractions(js_array_to_vec(arr)); })
      .function(
        "mole_fractions_liquid", +[](CoolProp::AbstractState& self) { return vec_to_js_array(self.mole_fractions_liquid_double()); })
      .function(
        "mole_fractions_vapor", +[](CoolProp::AbstractState& self) { return vec_to_js_array(self.mole_fractions_vapor_double()); })
      .function(
        "get_mole_fractions", +[](CoolProp::AbstractState& self) { return vec_to_js_array(self.get_mole_fractions()); })
      .function(
        "get_mass_fractions", +[](CoolProp::AbstractState& self) { return vec_to_js_array(self.get_mass_fractions()); })
